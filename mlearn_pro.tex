...
\begin{problem}
  Посмотрие на классное отражение ходулочника в воде :)
...
\[
  ...
  \end{pmatrix}
\]
Найдите такую последовательность отражений, которая превращает матрицу $X$ в бидиагональную матрицу $\Sigma$. То есть у матрицы $\Sigma$ только на главной диагонали и на линии выше главной диагонали могут стоять ненулевые числа. Отражения можно применять слева и справа:
\[
X = U_2 U_1 \Sigma V_1'
\]
\begin{sol}
