...
\begin{problem}
Величины $X$ и $Y$ независимы, и являются компонентами вектора $V$, $V=(X, Y)$. Как связаны энтропия $V$ и энтропии $X$ и $Y$?
\begin{sol}
\[
H(V) = H(X) + H(Y)
\]
...
\begin{problem}
Дискретные величины $X$ и $Y$ независимы, и являются компонентами вектора $V$, $V=(X, Y)$. Как связаны индекс Джини $V$ и индексы Джини $X$ и $Y$?
\begin{sol}
