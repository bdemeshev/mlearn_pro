...
\begin{sol}
\begin{enumerate}
\item $D_{KL} (p||q) = 3 \cdot \frac{1}{3} \ln 3 - \left(\frac{1}{3} \ln \left(\frac{2}{3}\right)^2 + \frac{1}{3} \ln \left(\frac{4}{9}\right) + \frac{1}{3} \ln \left(\frac{1}{3}\right)^2 \right)   = \ln 3 - \frac{4}{3} \ln 2 \approx 0.17$
