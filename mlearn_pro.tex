...
\begin{enumerate}
  \item Найдите вероятность поимки Джеймса Бонда на каждой из дорог для $\sigma=1$, $\sigma \to 0$, $\sigma \to 1$.
  ...
  \item Какова вероятность поимки Джеймса Бонда на каждой из дорог для $\sigma=1$, $\sigma \to 0$, $\sigma \to 1$, если по последним разведданным он был заброшен в точку $A$?
\end{enumerate}
